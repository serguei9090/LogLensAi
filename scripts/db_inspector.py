...
def get_db_inspector(verbose=False):
    ...
    try:
        ...
        summary = {
            ...
            "workspaces": [{"id": ws_id, "logs": count} for ws_id, count in workspace_logs.items()],
        }
...
def main():
    ...
    parser.add_argument(
        "-v", "--verbose", action="store_true", help="Include detailed samples and metadata"
    )
