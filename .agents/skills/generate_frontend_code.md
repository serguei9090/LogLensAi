...
- **Rich Aesthetics**: 
  - Mandatory use of modern, premium visual design (curated palettes from `docs/design/theme.md`, glassmorphism, dynamic animations).
...
## Instructions
1. **Read the Layout/Contract**: Open and carefully study `docs/track/Technical_Specification.md` and `docs/API_SPEC.md`.
2. **Setup Design Foundation**: Use tokens from `docs/design/theme.md`.
