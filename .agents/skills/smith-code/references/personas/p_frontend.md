...
- **Required Rules**:
  ...
  - Always read `references/rules/UI/AtomicDesignStandard.md` for component work.
  - Read `references/rules/UI/UIInfrastructureStandards.md` for hooks, theme, utilities, or shared UI infrastructure.
  - Read `references/rules/UI/MotionSystemStandard.md` for animation or transition work.
  - Read `references/rules/StateManagement/StateManagementStandard.md` for global, server, or URL state changes.
  - Read `references/rules/Internationalization/i18nStandard.md` when user-facing strings change in an i18n project.
  - Read `references/rules/Performance/PerformanceStandard.md` for rendering, bundle, list, or media performance work.
