...
- **Required Rules**:
  - Always read `references/rules/System/NoGuesswork.md`.
  - Always read `references/rules/System/IntelligenceStack.md` for full SDLC work.
  - Always read `references/rules/System/SkillMatrix.md` before selecting supporting skills.
  - Read `references/rules/System/DocsFirst.md` when external library or framework behavior affects the spec.
  - Read `references/rules/Architecture/DiagramStandard.md` when the spec needs a diagram.
- **Responsibilities**:
