...
- **Workflow Anchor Law**: Full-SDLC plans MUST be anchored in a bead via `bd create` or `bd update` before implementation. Lightweight tasks may proceed without a bead when scope is small, clear, and low risk.
