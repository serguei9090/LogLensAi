---
description: "Documentation Writer (Manual) - WikiFlow sub-agent workflow."
---
# Documentation Writer (Manual) Workflow
<!-- MANUAL MODE: Ask user for confirmation before proceeding -->

## Objective
Execute the responsibilities of the Documentation Writer with professional-grade context awareness.
...
2. **Execute Task:** Perform the required Documentation Writer duties. Document your localized reasoning in `docs/WikiFlow/docs/`.
