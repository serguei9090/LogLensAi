---
description: "Scripting Coder (Manual) - WikiFlow sub-agent workflow."
---
# Scripting Coder (Manual) Workflow
<!-- MANUAL MODE: Ask user for confirmation before proceeding -->

## Objective
Execute the responsibilities of the Scripting Coder with professional-grade context awareness.
...
2. **Execute Task:** Perform the required Scripting Coder duties. Document your localized reasoning in `docs/WikiFlow/coder_script/`.
