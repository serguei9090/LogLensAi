---
description: "Frontend Coder (Manual) - WikiFlow sub-agent workflow."
---
# Frontend Coder (Manual) Workflow
<!-- MANUAL MODE: Ask user for confirmation before proceeding -->

## Objective
Execute the responsibilities of the Frontend Coder with professional-grade context awareness.
...
2. **Execute Task:** Perform the required Frontend Coder duties. Document your localized reasoning in `docs/WikiFlow/coder_front/`.
