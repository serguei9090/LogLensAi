---
description: "Product Manager (Manual) - WikiFlow sub-agent workflow."
---
# Product Manager (Manual) Workflow
<!-- MANUAL MODE: Ask user for confirmation before proceeding -->

## Objective
Execute the responsibilities of the Product Manager with professional-grade context awareness.
...
2. **Execute Task:** Perform the required Product Manager duties. Document your localized reasoning in `docs/WikiFlow/pm/`.
