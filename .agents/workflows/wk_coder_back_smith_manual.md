---
description: "Backend Coder (Manual) - WikiFlow sub-agent workflow."
---
# Backend Coder (Manual) Workflow
<!-- MANUAL MODE: Ask user for confirmation before proceeding -->

## Objective
Execute the responsibilities of the Backend Coder with professional-grade context awareness.
...
2. **Execute Task:** Perform the required Backend Coder duties. Document your localized reasoning in `docs/WikiFlow/coder_back/`.
