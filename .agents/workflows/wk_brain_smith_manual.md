---
description: "Brainstorm & Architect (Manual) - WikiFlow sub-agent workflow."
---
# Brainstorm & Architect (Manual) Workflow
<!-- MANUAL MODE: Ask user for confirmation before proceeding -->

## Objective
Execute the responsibilities of the Brainstorm & Architect with professional-grade context awareness.
...
2. **Execute Task:** Perform the required Brainstorm & Architect duties. Document your localized reasoning in `docs/WikiFlow/brain/`.
3. **Write Resume:** Overwrite `docs/WikiFlow/handoff_resume.md`.
   - **Precision Payload:** When documenting your work in the resume, provide EXACT file paths, function names, and line numbers in the `Actionable Artifacts` section.
