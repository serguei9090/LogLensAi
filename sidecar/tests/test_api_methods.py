...
def api():
    ...
    app.ai = MagicMock()
    app.ai.analyze.return_value = {"summary": "test", "root_cause": "test", "recommended_actions": []}
    yield app
...
def test_ingest_and_fetch_logs(api):
    logs = [
        IngestLogEntry(workspace_id="ws1", source_id="src1", raw_text="2023-01-01 10:00:00 INFO Order processed", level="INFO"),
        IngestLogEntry(workspace_id="ws1", source_id="src1", raw_text="2023-01-01 10:01:00 ERROR Database timeout", level="ERROR")
    ]
...
def test_get_log_distribution(api):
    api.method_ingest_logs([
        IngestLogEntry(workspace_id="ws1", source_id="src1", raw_text="2023-01-01 10:00:00 INFO Test", timestamp="2023-01-01 10:00:00"),
        IngestLogEntry(workspace_id="ws1", source_id="src1", raw_text="2023-01-01 10:00:30 INFO Test", timestamp="2023-01-01 10:00:30")
    ])
...
def test_log_comment(api):
    api.method_ingest_logs([
        IngestLogEntry(workspace_id="ws1", source_id="src1", raw_text="test")
    ])
