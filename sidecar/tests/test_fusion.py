...
def test_get_fused_logs_with_timezone_shift(api):
    ...
    api.method_ingest_logs([
        IngestLogEntry(workspace_id="ws1", source_id="src_london", raw_text="2024-01-01 10:00:00 INFO London event", timestamp="2024-01-01 10:00:00"),
        IngestLogEntry(workspace_id="ws1", source_id="src_nyc", raw_text="2024-01-01 10:00:00 INFO NYC event", timestamp="2024-01-01 10:00:00")
    ])
