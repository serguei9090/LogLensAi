...
class OllamaProvider(AIProvider):
    ...
    def __init__(self, host: str = "http://localhost:11434", system_prompt: str = "", model: str = DEFAULT_OLLAMA_MODEL):
    ...
    async def analyze_logs(self, template: str, samples: list[str], model: str | None = None) -> dict:
