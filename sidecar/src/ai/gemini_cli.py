...
class GeminiCLIProvider(AIProvider):
    ...
    async def _chat_cold(
        self, messages: list[AIChatMessage], model: str | None = None
    ) -> AIChatMessage:
        ...
        try:
            ...
            if process.returncode != 0:
                ...
                return AIChatMessage(
                    role="assistant",
                    content=f"Gemini CLI Error (Code {process.returncode}): {error_msg}",
                )
